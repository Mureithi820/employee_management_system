...
function downloadPayslipPDF(record) {
    ...
    pdf.text(`Employee Name: ${record.full_name}`, 10, 20);
    pdf.text(`Gross Salary: ${record.gross_salary}`, 10, 30);
    pdf.text(`Net Salary: ${record.net_salary}`, 10, 40);
    pdf.text(`Date: ${record.created_at}`, 10, 50);
