...
<div class="container">
    ...
    <button class="btn btn-danger mb-3" id="download-leave-requests">Download All Leave Requests</button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php endif; ?>
                    <a href="delete_leave_request.php?page=leave_request_management_delete&id=<?= $request['id'] ?>" class="btn btn-secondary btn-sm" onclick="return confirm('Are you sure you want to delete this leave type?');">Delete</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
